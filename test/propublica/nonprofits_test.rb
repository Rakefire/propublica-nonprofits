...
class Propublica::NonprofitsTest < Minitest::Test
  ...
  def test_it_lazily_searchs_multiple_nonprofits_with_state_limiter
    VCR.use_cassette("rural_search_limit_ohio") do
      rural_action_results = Propublica::Nonprofits.lazy_search("rural", state: "OH")

      assert_instance_of Enumerator::Lazy, rural_action_results
      assert_nil rural_action_results.size
  ...
  def test_it_searchs_multiple_nonprofits_with_state_limiter_fetching_all
  ...
  def test_organization_details_parsing
    VCR.use_cassette("rural_action_ein") do
      ...
      assert_equal "9030 HOCKING HILLS DR", rural_action.details.address
      assert_equal "THE PLAINS", rural_action.details.city
      assert_equal "OH", rural_action.details.state
      assert_equal "45780-1209", rural_action.details.zipcode
